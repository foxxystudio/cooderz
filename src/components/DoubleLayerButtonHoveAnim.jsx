...
export default function DoubleLayerButtonHoverAnim({ text, font, color, bg, bgHover, href, target, icon }) {
   ...
   }, { scope: btnRef, dependencies: [text, font, color, bg, bgHover, href, target, icon] });

   return (
      <div ref={btnRef} className={`btn__wrapper hover-text-anim__wrapper ${bg} ${bgHover}`}>
